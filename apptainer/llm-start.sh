...
timeout 24h apptainer exec --nv --bind ${LOCAL_JOB_DIR}:/opt/output ./apptainer/llm_train.sif python -m src.train.llm --training \
    --train-batch-size=100 --eval-batch-size=400 \
    --logging-steps-ratio=0.0001 --eval-steps-ratio=0.1 \
    --n-epochs=1
